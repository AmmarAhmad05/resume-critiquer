    ...
    return (
      <div className="min-h-screen relative flex items-center justify-center gradient-bg px-4 overflow-hidden">
        ...
        <div className="parallax-bg">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-indigo-300/20 dark:bg-indigo-500/10 rounded-full blur-3xl floating" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-pink-300/20 dark:bg-pink-500/10 rounded-full blur-3xl floating" style={{ animationDelay: '4s' }}></div>
        </div>
        ...
        <div className="card max-w-md w-full scale-in relative z-10">
          <div className="text-center mb-8 slide-in-up">
            ...
            <p className="text-gray-600 dark:text-gray-400 font-medium">AI-powered resume grading & analysis</p>
          </div>
          ...
          <div className="mt-8 text-center slide-in-up" style={{ animationDelay: '0.3s' }}>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link to="/signup" className="text-transparent bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text font-bold hover:from-indigo-500 hover:to-purple-500 transition-all">
                Sign up
              </Link>
            </p>
          </div>
